...
class TestBidLimitModel(AlveareModelTestCase):
    ...
    def test_create(self):
        self.assertEqual( len(self.auction.ticket_set.bid_limits), 2)
        bid_limit_0 = self.auction.ticket_set.bid_limits[0]
        bid_limit_1 = self.auction.ticket_set.bid_limits[1]
    ...
    def test_delete(self):
        ...
        self.delete_instance(bid_limits[0])
        self.delete_instance(bid_limits[1])
    ...
    def test_bad_create(self):
        with self.assertRaises(ValueError):
            self.auction.ticket_set.add(self.ticket_2, -10)
        with self.assertRaises(ValueError):
            self.auction.ticket_set.add(self.ticket_2, 'foo')
