...
def with_at_least_one_project(query):
...
class TestProjectResource(BaseProjectTestCase):

    def test_get_all_as_admin(self):
        self.get_all_as_admin()

    def test_get_all_as_manager(self):
        self.get_all_as_manager(with_at_least_one_project)
    ...
    def test_get_one_as_manager(self):
        self.get_one_as_manager(with_at_least_one_project)
    ...
    def test_update_as_manager(self):
        self.update_as_manager(with_at_least_one_project)
