...
class TestRemoteWorkHistoryResource(RebaseRestTestCase):
    def setUp(self):
        self.remote_work_history_resource = RebaseResource(self, 'RemoteWorkHistory')
        super().setUp()
    ...
    def test_add_and_remove_accounts(self):
        ...
        rwh = self.remote_work_history_resource.get_any()
        rwh_id = rwh['id']
        new_account = RebaseResource(self, 'GithubAccount').create(
