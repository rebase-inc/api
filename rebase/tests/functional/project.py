...
class BaseProjectTestCase(RebaseRestTestCase):
    def setUp(self):
    ...
    def delete_as_admin(self):
        ...
        RebaseResource(self, 'CodeRepository').get(project['code_repository'], 404)
    ...
    def add_and_remove_tickets(self):
        self.login_admin()
        project = self.project_resource.get_any()
        internal_ticket_resource = RebaseResource(self, 'InternalTicket')
        ticket_resource = RebaseResource(self, 'Ticket')
        ticket = dict(
    ...
    def add_and_remove_code_clearance(self):
        ...
        cc = RebaseResource(self, 'CodeClearance')
