...
class TestComment(RebaseNoMockRestTestCase):
    def setUp(self):
        ...
        self.ticket_resource =      RebaseResource(self, 'Ticket')
        self.mediation_resource =   RebaseResource(self, 'Mediation')
        self.review_resource =      RebaseResource(self, 'Review')
        self.feedback_resource =    RebaseResource(self, 'Feedback')
